% Modified for Jpeg encoded block DCT image

function [D_best,ann] = PatchMatch_J(IM_a,IM_b,itern)

global SIZE; global PATCHSIZE; global INTERVALSIZE;
SIZE = size(IM_a);
patchSize = 8; PATCHSIZE = patchSize;
intervalSize = patchSize; INTERVALSIZE = intervalSize;
global MAX_X; 
global MAX_Y;
