%Chih-Yuan Yang
%10/30/12
%New dictionary between reconstructed HR image and original HR image, there is no more LR images
clc
clear
close all
...
para.settingnote = '';
para.tuning = 4;
para.tuningnote = 'New dictionary and new flow HR to HR';
para.legend = 'Jianchao';
folder_dictionary = fullfile('Data','Upfrontal3','s4','Dictionary_test1');
