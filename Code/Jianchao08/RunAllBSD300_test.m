...
TestIIDS = dlmread('Data\Test\BSDS300\iids_test.txt');
% =====================================================================
...
for i= idxStart:length(TestIIDS)
    clear ReconIm
    FileNameShort = num2str(TestIIDS(i));
    ...
    imwrite(uint8(ReconIm),['Data/Test/BSDS300Result_test\' num2str(i) '_' FileNameShort '_Jianchao.png']);
end