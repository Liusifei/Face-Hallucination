%Chih-Yuan Yang
%11/12/12
%This file is modified from Test_Upfrontal3_4, for Nonupfrontal basis and dictionary
clc
clear
close all
...
para.testimagefolder = '\\VISION-U1\Sfliu\PIE_for Paper\testing\NonUpfrontal_show\25';
para.savefolder = 'GeneratedImages';
para.setting = 4;
para.settingnote = 'For compressed image';
para.tuning = 1;
para.tuningnote = 'Compression 25';
