...
FileNameShort = 'Woman_input_n0.01';
fname = ['Data/Test/' FileNameShort '.png'];
%testIm = imread(fname); % testIm is a high resolution image, we downsample it and do super-resolution
%Feb 8 Chih-Yuan
%change input as the low, imresize as high
lowIm = imread(fname);
testIm = imresize(lowIm , 3 );
...
title('Our method');
imwrite(uint8(ReconIm),['Data/Test/' FileNameShort '_Jianchao.png']);