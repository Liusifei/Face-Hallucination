...
%the lambda can not change because the parameter need to be kept the same as training
lambda = 0.1;      %the value reported from the paper is doubtable, coef w becomes all zero because the weight is too large 50 * patchfeaturelength;
