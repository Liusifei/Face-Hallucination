...
%folder_imagecrop = fullfile('Source','Upfrontal2','GroundTruth');       %folder of images to crop
folder_imagecrop = folder_eyecenter;
folder_landmark_raw = fullfile('Examples','MetaData','AllLandmarks_Upfrontal');
folder_image_save = fullfile('Examples','Upfrontal3','Training');
folder_landmark_save = fullfile('Examples','Upfrontal3','Landmarks');
%folder_image_save = fullfile('Source','Upfrontal3','GroundTruth');
...
for i=1:filenumber
    ...
    if bcropimage
        ...
        fn_save = sprintf('%s_align_crop.png',fn_image_short);
