%Chih-Yuan Yan
%4/10/14
%I need to rerun compressed inputs through our CVPR13 algorihtm because Sifei wrongly uses the landmarks of
%non-compressed inputs.
clc
clear
close all
...
folder_save = fullfile('Result','Test14_RerunCVPR13_CompressedInput_Landmark');
...
for fileidx=idx_file_start:idx_file_end
    ...
    [gradient_edge, weightmap_edge] = F21f_EdgePreserving_GaussianKernel(img_y,sf,Gau_sigma);
