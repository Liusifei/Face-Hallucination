...
for fileidx=fileidx_start:fileidx_end
    ...
    %boost the weightmap_edge
    weightmap_edge_x2 = min(weightmap_edge * 2, 1);
    gradient_UbPlusUe = gradient_edge .*repmat(weightmap_edge_x2, [1 1 8]) + gradients_texture .* repmat(1-weightmap_edge_x2,[1 1 8]);    
...
%    gradient_UbPlusUe = gradientwholeimage;
    ...
    fn = sprintf('%s_%s_%d_%d_UbUeUc.png',fn_testshort,para.legend,para.setting,para.tuning);
    imwrite(img_out, fullfile(finalsavefolder,fn));
