%Chih-Yuan Yang
%10/02/12
%F34a: I add new inputs to support the scaling factor of 3. I also replace F19a to F19c.
function [mask_lr, mask_hr] = F34a_ComputeMask_Eyes(landmarks_hr, scalingfactor, Gau_sigma)
