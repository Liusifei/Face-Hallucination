...
function img_out = F27_SmoothnessPreserving(img_y,zooming,Gau_sigma)
    ...
    for loop = 1:LoopNumber
        ...
        %this I is the I_1 on Line 5 of Algorithm 1
        I = ValueSum ./ WeightSum;
        
        %intensity compensate
        diff_lr = F19a_GenerateLRImage_GaussianKernel(I,zooming,Gau_sigma) - img_y;
