...
fn_filelist = 'Upfrontal3AlignedTest.txt';
folder_multipli = 'D:\Documents\Research\Datasets\Face\Multi-Pie';     %MultiPIE
folder_dst = fullfile(pwd,'Source','Upfrontal3_1HighContrast','Raw');
str_highconstrast_appendix = '13';  %it should be '13' or '02'. '13' is stronger
...
for idx_file = 1:num_files
    ...
    fn_source = sprintf('%s_%s_%s_%s_%s.png',str_identity,str_session,str_expression,str_cameraposition,str_highconstrast_appendix);
