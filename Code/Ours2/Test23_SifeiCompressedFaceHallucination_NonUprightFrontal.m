...
filename_glasslist = 'GlassList_NonUpfrontal_Example_274.txt';
...
addpath(fullfile(folder_Lib,'Lab2RGB'));
addpath(fullfile(folder_Lib,'RGB2Lab'));

scalingfactor = 4;
Gau_sigma = 1.6;
folder_exemplarimages = fullfile('Examples','NonUpfrontal3','PreparedMatForLoad');
...
for fileidx=idx_file_start:idx_file_end
    ...
    %    modelname = 'p99';    %all the three models fail
        ...
        %the detection may be wrong for non-upright frontal faces
        try
