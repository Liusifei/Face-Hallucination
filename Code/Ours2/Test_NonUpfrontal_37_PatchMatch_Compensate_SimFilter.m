...
para.zooming = 4;
para.settingname = 'Ours3';
para.testimagefolder = fullfile(codefolder,'Ours3_nonupfrontal','Source','NonUpfrontal','Input');
para.savefolder = 'GeneratedImages';   %relative folder to tuning folder
para.setting = 1;
para.settingnote = '';
para.tuning = 33;
para.tuningnote = 'PatchMatch retrieval including patch compensation and similarity filter';
para.legend = 'Ours';
para.model = 'mi';
para.detectedlandmarkfolder = fullfile(codefolder,'Ours3_nonupfrontal','Temp','DetectedLandmarks');
para.glasslistfolder = fullfile(codefolder,'Ours3_nonupfrontal','Examples','NonUpfrontal');
para.loadfolder = fullfile(codefolder,'Ours3_nonupfrontal','Examples','NonUpfrontal','PreparedMatForLoad');
...
for fileidx=para.fileidx_start:para.fileidx_end
    ...
    [gradients_texture img_texture img_texture_backprojection] = F37e_GetTexturePatchMatch_PatchCompensate_SimilarityFilter(img_y, rawexampleimages, rawexampleimages_lr);
    
    
    %[gradient_expected gradient_actual weightmap_edge img_edge] = F21d_EdgePreserving_GaussianKernel(img_y,para.zooming,para.Gau_sigma);
