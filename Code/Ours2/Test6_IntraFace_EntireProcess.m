...
folder_save = fullfile('Result','Test6_IntraFace_PubFig_HighContrast');
...
for idx_file_test=idx_file_start:idx_file_end
    ...
    fn_save_img = sprintf('%s_%s.png',fn_short,str_legend);
    ...
    [gradients_texture, img_texture, img_texture_backprojection] = ...
        F37g_GetTexturePatchMatch_Aligned(img_y, rawexampleimage, allLRexampleimages, landmark_test, rawexamplelandmarks);
%        F37f_GetTexturePatchMatch_Aligned(img_y, rawexampleimage, allLRexampleimages, landmark_test, rawexamplelandmarks);
