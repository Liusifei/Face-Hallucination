...
function [gradient_expected weightmap_edge] = F21e_EdgePreserving_GaussianKernel(img_y,zooming,Gau_sigma)
    ...
    lambda_d = 0.25;
    d0 = 0.25;
    %I used an exponential function here. So it is not a linear function with coef alpha
