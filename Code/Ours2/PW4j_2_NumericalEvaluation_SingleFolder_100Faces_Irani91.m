...
%PW4j_1: Compute the DIIVINE of ground truth image
%PW4j_2: evaluate results of Irani91
...
folder_source = fullfile(folder_code,'BackProjection','Result','UPfrontal3','Tuning1','GeneratedImages');
folder_save = fullfile('Result','PaperWriting1_PAMI');
fn_save_head = 'Upfrontal3_100face_Irani91';
...
str_appendix_evaluated = '_backprojection_3_1.png';
