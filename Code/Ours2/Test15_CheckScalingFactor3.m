%Chih-Yuan Yan
%07/19/14
%Test the setting of scaling factor of 3, based on Mr. Fang's requirement. This file has to run on a Linux
%machine because it online computes the landmarks of the test images.
clc
clear
close all
...
folder_save = fullfile('Result','Test15_CheckScalingFactor3');
...
folder_test = fullfile('Source','Upfrontal3','Input_scalingfactor3');
