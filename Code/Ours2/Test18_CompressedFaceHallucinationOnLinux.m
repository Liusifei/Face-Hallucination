%Chih-Yuan Yan
%1/27/15
%I need to correct Sifei's algorithm by generating landmarks from compressed inputs
clc
clear
close all
...
fn_example_LR_ycbcr = sprintf('ExampleDataForLoad_L.mat');        %size of the ExampleDataForLoad_L.mat: 80*60*3*2184.
...
load(fullfile(folder_exemplarimages,fn_example_LR_ycbcr));
%exampleimages_lr will be loaded here
...
%This is the ycbcr high-resolution example face images.
load(fullfile(folder_exemplarimages,'ExampleDataForLoad_H'));
%exampleimages_hr will be loaded here

[a,b,c,d] = size(exampleimages_hr);
rawexampleimage = reshape(exampleimages_hr(:,:,1,:),[a,b,d]);
%The Y channels of the high-resolution example images are extracted here.
