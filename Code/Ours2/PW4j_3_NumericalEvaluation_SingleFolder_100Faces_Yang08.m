...
folder_source = fullfile(folder_code,'Jianchao08','Result','UPfrontal3','Tuning4','GeneratedImages');
folder_save = fullfile('Result','PaperWriting1_PAMI');
fn_save_head = 'Upfrontal3_100face_Yang08';
...
str_appendix_evaluated = '_Jianchao_3_4.png';
