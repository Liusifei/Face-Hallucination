...
folder_files = fullfile(folder_project,'PaperWriting','CVPR13','manuscript','figs','Results','Failure2','Ali_Landry_0071');

fn_short = 'Ali_Landry_0071';

k=0;
k=k+1;appendix_read{k} = '_backprojection_2_1.png';
k=k+1;appendix_read{k} = '_Jianchao_2_1.png';
k=k+1;appendix_read{k} = '_Ma10.png';
k=k+1;appendix_read{k} = '_Liu07.png';
k=k+1;appendix_read{k} = '_Ours_2_1.png';
k=k+1;appendix_read{k} = '.png';
groundtruthfileext = '.png';

k=0;
k=k+1;appendix_write{k} = '_backprojection_2_1';
k=k+1;appendix_write{k} = '_Jianchao_2_1';
k=k+1;appendix_write{k} = '_Ma10';
k=k+1;appendix_write{k} = '_Liu07';
k=k+1;appendix_write{k} = '_Ours_2_1';
