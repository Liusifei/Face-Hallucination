...
fn_filelist = 'JANUSProposal.txt';
%current problem: the exemplar HR images are 640x480, and the averaged eye
%distance is approximately 100 pixels. If the 4x images generate faces
%whose eye distance is significantly greater than 100 pixels, there may be
%alignment problem.
...
% folder_filelist = 'FileList';
% fn_filelist = 'PubFig_Foundable_8027.txt';
