...
%Test_Upfrontal3_2: Test face imagew with high contrast illumination
clc
clear
close all
...
sf = 4;
Gau_sigma = 1.6;
folder_save = fullfile('Result','Upfrontal3_1');
folder_test = fullfile('Source','Upfrontal3_1HighContrast','Input');
folder_landmark_detected = fullfile('Landmarks','Detected','Upfrontal3_1HighContrast');
folder_filelist = 'Filelist';
fn_filelist_test = 'TestImage342UpfrontalHighContrast.txt';
str_legend = 'Ours_3_2';
